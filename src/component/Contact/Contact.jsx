...
export default function Contact() {
  return (
    ...
    <div className="container">
        <h2 className="text-uppercase fs-1 fw-bold text-center">Contact Me</h2>
        <div className="divider-custom">
            <div className="divider-custom-line"></div>
            <div className="divider-custom-icon"> <i className='fas fa-star fs-1'></i></div>
            <div className="divider-custom-line"></div>
        </div>
        <div className="row">
            <div className="col-lg-8 mx-auto">
                <form id="contactForm" name="sentMessage">
                    ...
                    <br />
                    <div id="success"></div>
                    <div className="form-group"><button className="btn btn-xl fs-4" id="sendMessageButton" type="submit">Send</button></div>
                </form>
            </div>
        </div>
    </div>
